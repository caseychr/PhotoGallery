...
public class PollService extends IntentService
{
    ...
    public static final String ACTION_SHOW_NOTIFICATION =
            "com.bignerdranch.anroid.photogallery.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE =
            "com.bigneranch.android.photogallery.PRIVATE";
    ...
    public static void setServiceAlarm(Context context, boolean isOn)
    {
        ...
        QuertPreferences.setAlarmOn(context, isOn);
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        String query = QuertPreferences.getStoredQuery(this);
        String lastResultId = QuertPreferences.getLastResultId(this);
        ...
        if(resultId.equals(lastResultId))
            Log.i(TAG, "Got an older result: "+resultId);
        else
        {
        ...
        QuertPreferences.setLastResultId(this, resultId);
    }
