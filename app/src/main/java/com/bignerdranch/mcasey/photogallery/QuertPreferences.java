...
public class QuertPreferences
{
    ...
    {
        return PreferenceManager.getDefaultSharedPreferences(context).getBoolean(PRED_IS_ALARM_ON, false);
    }

    public static void setAlarmOn(Context context, boolean isOn)
    {
        PreferenceManager.getDefaultSharedPreferences(context).edit().putBoolean(PRED_IS_ALARM_ON, isOn).apply();
    }
}
